...
function About() {
  return (
    ...
    <HashLink className = "" to= "/#about" spy={true} smooth={true} offset={50} duration={500}><img className=" lg:hover:scale-125 absolute  top-0 left-32  -mt-52  lg:max-w-screen-sm lg:max-h-screen-sm md:max-w-md md:max-h-md rounded-lg h-initial shadow-2xl " src={CVImg}></img></HashLink>
