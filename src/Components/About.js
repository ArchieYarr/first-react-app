    ...
    <div className=" flex flex-col  place-items-start px-8 ">
            ...
            <div className="text-justify">
              <p className="pt-8 pb-2">
                I'm a curios designer and technology geek who's committed to advocating for the user wherever I'm working. 
                I believe that effective user centric design can have real impact on peoples lives no matter how big or small. 
              </p>
