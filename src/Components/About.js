...
function About() {
  return (
    ...
    <HashLink className = "sm:max-w-md sm:max-h-md" to= "/#about" spy={true} smooth={true} offset={50} duration={500}><img className=" lg:hover:scale-110 md:hover:scale-105 md:absolute  mx-2 top-0 lg:left-32  lg:-mt-52 md:-mt-24 lg:max-w-screen-sm lg:max-h-screen-sm sm:max-w-md sm:max-h-md rounded-lg h-initial shadow-2xl " src={CVImg}></img></HashLink>
