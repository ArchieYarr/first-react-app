...
function About() {
  return (
    <div className="relative  md:px-8 lg:pl-40 lg:pr-64 h-screen pt-8 md:pt-4 " >
    <HashLink className = "sm:max-w-md sm:max-h-md" to= "/#about" spy={true} smooth={true} offset={50} duration={500}><img className=" lg:hover:scale-110 md:hover:scale-105 absolute  top-0 lg:left-32  lg:-mt-52 md:-mt-24 lg:max-w-screen-sm lg:max-h-screen-sm sm:max-w-md sm:max-h-md rounded-lg h-initial shadow-2xl " src={CVImg}></img></HashLink>
    
          
    <div className="lg:ml-[42rem] md:ml-[30rem]  flex flex-col flex-wrap place-items-start">
    
            <h1 className="text-5xl font-bold  ">GCU Computing graduate from St Andrews, Scotland. Currently based in Glasgow.</h1>
