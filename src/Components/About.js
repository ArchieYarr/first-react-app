...
function About() {
  return (
    ...
    <HashLink className = "" to= "/#about" spy={true} smooth={true} offset={50} duration={500}><img className=" lg:hover:scale-110 md:hover:scale-105 md:absolute    px-1 top-0 lg:left-32  lg:-mt-52 md:-mt-24     lg:max-w-screen-sm lg:max-h-screen-sm  max-h-sm   rounded-lg h-initial shadow-2xl " src={CVImg}></img></HashLink>
    </div>
